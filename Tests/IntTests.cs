...
public static class IntTests
{
    ...
    public static void Test_ClearBitAt()
    {
        for (int i = 0; i < LoopCount; i++)
        {
            int result = TestValue.ClearBitAt(i);
    ...
    public static void Test_SetBitValueAt()
    {
        for (int i = 0; i < LoopCount; i++)
        {
            int result0 = TestValue.SetBitValueAt(i, 0);
            int result1 = TestValue.SetBitValueAt(i, 1);
    ...
    public static void Test_SetUnsetBitValueAt()
    {
        for (int i = 0; i < LoopCount; i++)
        {
            int result1 = TestValue.SetBitValueAt(i, 0).SetBitValueAt(i, 1);
            int result0 = TestValue.SetBitValueAt(i, 1).SetBitValueAt(i, 0);
            Assert.AreEqual(1, result1.BitAt(i),
