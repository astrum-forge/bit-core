...
public static class UShortTests
{
    ...
    public static void Test_UnsetBitAt()
    {
        for (int i = 0; i < LoopCount; i++)
        {
            ushort result = TestValue.UnsetBitAt(i);
    ...
    public static void Test_SetBit()
    {
        for (int i = 0; i < LoopCount; i++)
        {
            ushort result0 = TestValue.SetBit(i, 0);
            ushort result1 = TestValue.SetBit(i, 1);
    ...
    public static void Test_SetUnsetBit()
    {
        for (int i = 0; i < LoopCount; i++)
        {
            ushort result1 = TestValue.SetBit(i, 0).SetBit(i, 1);
            ushort result0 = TestValue.SetBit(i, 1).SetBit(i, 0);
            Assert.AreEqual(1, result1.BitAt(i),
